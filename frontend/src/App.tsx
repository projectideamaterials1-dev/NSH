    ...
    return (
      <div className="min-h-screen bg-void-black flex items-center justify-center">
        <div className="glass-panel border-laser-red p-8 text-center">
          <div className="text-laser-red font-mono text-xl mb-4 animate-pulse">
            ⚠️ TELEMETRY LINK LOST
          </div>
          <p className="text-muted-gray font-mono text-sm mb-6">
            Cannot connect to /api/visualization/snapshot
          </p>
          <button
